...
export function Optimized(props) {
  ...
  const tableMaterial = useMemo(
    () => new THREE.MeshPhongMaterial({ color: '#991818ff' }),
    []
  )
  ...
  const radiatorMaterial2 = useMemo(
    () => new THREE.MeshPhongMaterial({ color: '#110303ff' }),
    []
  )
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.radiator_blinn1_0001.geometry} material={radiatorMaterial2} />
